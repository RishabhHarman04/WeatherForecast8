...
namespace WindowsFormsApp5
{
    public partial class WeatherData : Form
    {
        ...
        {
            SettingForm _settingsForm = new SettingForm(_settings);

            _settingsForm.Shown += (sender, e) =>
            {
               this.Show();
            };
            ...
            if (_settingsForm._weathersettings != null)
            {
                _settings = _settingsForm._weathersettings;
